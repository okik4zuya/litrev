...
const Lits = () => {
    ...
    return (
        <Layout>
            <div className='bg-white mt-4 w-full md:w-1/2 rounded-lg shadow-lg p-8 flex flex-col items-center justify-center cursor-pointer'
                onClick={() => setShowLitForm(!showLitForm)}
            >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10">
                    <path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zM12.75 9a.75.75 0 00-1.5 0v2.25H9a.75.75 0 000 1.5h2.25V15a.75.75 0 001.5 0v-2.25H15a.75.75 0 000-1.5h-2.25V9z" clipRule="evenodd" />
                </svg>
                <div>Add Literature</div>
            ...
            {/*Absolut End*/}
            <div>
                <div className='my-2 font-normal text-md'>Result: </div>
            </div>
            <div className='mt-2'>
                {lits.map((item, key) => (
